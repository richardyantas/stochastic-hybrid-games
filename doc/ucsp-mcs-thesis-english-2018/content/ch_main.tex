\chapter{Safe and Near Optimal Controller Synthesis for Stochastic hybrid Games}
  ...
  \section{Experiments: }
    ...
    \subsection{Controllers Optimizations:}
      ...
      \subsubsection{ \emph{Reinforcement learning optimization} }
        ...
        \begin{figure}[!htb]        
          \begin{subfigure}{0.51\textwidth}
            ...
            \captionsetup{format=hang}
            \captionof{figure}{Temparatures comparison between safe greedy and 
            safe stratego controller.} \label{fig:resulta}
          \end{subfigure}
          \hspace*{\fill}
          \begin{subfigure}{0.51\textwidth}
      ...
      For $\alpha = 0.5$, the temperature mean error in the greedy method 
      ...
      a greedy method is $ \bigtriangleup E = 310.8Kw$ as \autoref{fig:resultb} shows. % 310800.0
