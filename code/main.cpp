...
int main()
{
    ...
    for ( int p = 1; p <= 3 ;i++) // piston
    {
        for(int r = 0; r <= 1; r++) // resistor
        {
            m = Function(x, Return( - 2.8811059759131854e-6*(x[0]-Te)/x[1] 
                                    //- v*9.34673995175876e-05*(x[0]-Ti)/x[1] // noise
                                     - 1/(1+pow(e,-1000*(0.1*p-x[1])))*9.34673995175876e-05*(x[0]-Ti)/x[1] // Expansion
                                     + 0.7*0.7*8.403225763080125e-07*I/x[1] 
                                     + r*0.0048018432931886426/x[1],
                                     0.1*( Interval(0.1*p) - x[1]) ) );
    ...
    -9.34673995175876e-05*(x[0]-Ti)/x[1] + 0.7*0.7*8.403225763080125e-07*I/x[1] 
    + 0.0048018432931886426/x[1],0.1*( Interval(0.1) - x[1]) ) );
    ...
    -9.34673995175876e-05*(x[0]-Ti)/x[1] + 0.7*0.7*8.403225763080125e-07*I/x[1] 
    + 0.0048018432931886426/x[1],0.1*( Interval(0.2) - x[1]) ) );
    ...
    -9.34673995175876e-05*(x[0]-Ti)/x[1] - 9.34673995175876e-05*(x[0]-Ti)/x[1]
    ...
    -9.34673995175876e-05*(x[0]-Ti)/x[1] - 9.34673995175876e-05*(x[0]-Ti)/x[1]
    + 0.7*0.7*8.403225763080125e-07*I/x[1] ,0.1*( Interval(0.3) - x[1]) ) );



    // v = 2 <- 1 , r = 0 

    Function m7 = Function(x, Return( -2.8811059759131854e-6*(x[0]-Te)/x[1] + 
    -9.34673995175876e-05*(x[0]-Ti)/x[1] - 9.34673995175876e-05*(x[0]-Ti)/x[1]
    + 0.7*0.7*8.403225763080125e-07*I/x[1] 
    ,0.1*( Interval(0.2) - x[1]) ) );
    ...
    Function m8 = Function(x, Return( -2.8811059759131854e-6*(x[0]-Te)/x[1] + 
    -9.34673995175876e-05*(x[0]-Ti)/x[1] - 9.34673995175876e-05*(x[0]-Ti)/x[1] 
    + 0.7*0.7*8.403225763080125e-07*I/x[1] ,0.1*( Interval(0.2) - x[1]) ) );
    ...
    */
    ...
    Function m2 = Function(x, Return( -0.005*x[0] + 1/(1+pow(2.71,x[1]) ), 0.001*sign(0.001) ));
