def query(X): 
	if (40<= X.T and X.T <= 40.4688) and (0.1<= X.V and X.V <= 0.3):
		return [[3], [3,7], [0,7], [1,4], [2,1], [2,1,5], [3,4,1], [3,5,3], [3,6,1], [0,1,4], [0,4,1], [0,5,3]]
	...
	if (41.875<= X.T and X.T <= 42.3438) and (0.1<= X.V and X.V <= 0.3):
		return [[3], [3,7], [0,7], [1,4], [2,1], [2,1,5], [3,4,1], [3,5,2], [3,6,3], [0,1,4], [0,4,1], [0,5,3], [0,6,1], [2,0,1]]
	if (42.3438<= X.T and X.T <= 42.8125) and (0.1<= X.V and X.V <= 0.3):
		return [[3], [3,7], [0,7], [1,4], [2,1], [2,1,5], [3,4,1], [3,5,2], [3,6,3], [0,1,4], [0,4,1], [0,5,3], [0,6,1]]
	if (42.8125<= X.T and X.T <= 43.2812) and (0.1<= X.V and X.V <= 0.3):
		return [[3], [3,7], [0,5], [1,4], [2,1], [2,1,5], [3,4,3], [3,5,2], [3,6,3], [0,1,4], [0,4,1], [2,0,7]]
	...
	if (43.75<= X.T and X.T <= 44.2188) and (0.1<= X.V and X.V <= 0.3):
		return [[3], [3,7], [0,5], [1,4], [2,3], [2,3,5], [3,4,3], [3,5,2], [3,6,3], [0,1,4], [0,4,3], [2,0,7], [2,1,4], [2,2,3]]
	...
	if (46.0938<= X.T and X.T <= 46.5625) and (0.1<= X.V and X.V <= 0.3):
		return [[2], [2,3], [2,3,6], [0,5], [1,4], [0,4,3]]
	if (46.5625<= X.T and X.T <= 47.0312) and (0.1<= X.V and X.V <= 0.3):
		return [[2], [2,3], [2,3,6], [0,5], [0,4,3], [1,4,2], [1,6,4]]
	...
	if (57.3438<= X.T and X.T <= 57.8125) and (0.1<= X.V and X.V <= 0.3):
		return [[2], [2,6], [0,4], [0,4,5], [2,3,4], [2,4,2], [2,5,0], [0,0,7]]
	if (57.8125<= X.T and X.T <= 58.2812) and (0.1<= X.V and X.V <= 0.3):
		return [[2], [2,6], [0,4], [0,4,5], [2,3,4], [2,4,0], [2,5,0], [0,0,7]]
